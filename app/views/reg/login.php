            ...
            <div class="panel-heading">
                ...
                <fieldset>
                    <div class="form-group">
                        <input class="form-control" value="<?php if ($this->session->flashdata('username')): echo $this->session->flashdata('username');
                    endif;
                    ?>" placeholder="User Name" name="username" type="text" autofocus>
                    </div>
                    <div class="form-group">
                        <input class="form-control" placeholder="<?php if ($this->session->flashdata('username')): echo "The password you entered";
                               endif;
